export const projects = [
  {
    ...
    description: "AS Find Your Fit is a chance for students to meet current members of AS's offices and services and learn more about your resources on campus.",
  ...
  },
  {
    ...
    description: "Triton Fest is UC San Diego’s late night, weekend event series held at the beginning of the fall and winter quarters. From delicious free food to cultural performances, from go-kart racing to live music, there’s something for everyone at each Triton Fest event.",
    tools: "HTML, CSS, JavaScript, Figma",
    date: "August 2020",
